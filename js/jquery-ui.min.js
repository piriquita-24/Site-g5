        ...
        t.fn.extend({
            effect: function() {
                function i(e) {
                    ...
                    var l = t(this);
                    s.mode = u.shift(),
                    t.uiBackCompat === !1 || o ? "none" === s.mode ? (l[c](),
                    r()) : n.call(l[0], s, i) : (l.is(":hidden") ? "hide" === c : "show" === c) ? (l[c](),
                    r()) : n.call(l[0], s, r)
                }
